...
def jfrogUpload() :
    ...
    url = 'http://43.204.217.23:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    file_path = '/var/lib/jenkins/workspace/jdevops/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    username = 'admin'
